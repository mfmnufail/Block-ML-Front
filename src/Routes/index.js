...
import DeployContract from '../Components/SmartContract/DeployContract';
...
const index = () => {
  return (
      <Routes>
          ...
          <Route path='/smartcontract' element={<DeployContract/>}/>
          <Route path='/auction' element={<SmartContract/>}/>
